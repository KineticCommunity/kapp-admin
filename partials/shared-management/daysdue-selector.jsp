...
<div class="attribute m-b-2">
	...
	<input aria-describedby="helpBlock-${thisAttribute.name}" type="text" name="${thisAttribute.name}" class="attributeValue spinner" value="${currentObj.getAttributeValue(thisAttribute.name)}">
</div>