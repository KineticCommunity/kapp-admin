...
<c:set var="fields" value="${AdminHelper.getDatastoreColumns(currentRobot, 'Robot Configuration')}" scope="request" />
<json:object>
  <json:array name="columns">
    ...
    <json:object>
      <json:property name="title" value="Robot Record ID"/>
    ...
    <json:object>
      ...
      <json:property name="defaultContent" value="<div class=\"btn-group robot-btns\"><button class=\"btn btn-xs btn-default edit\" title=\"Edit\"><span class=\"fa fa-pencil fa-fw\"></span></button><button class=\"btn btn-xs btn-success clone\" title=\"Clone\"><span class=\"fa fa-clone fa-fw\"></span></button><button class=\"btn btn-xs btn-danger delete\" title=\"Delete\"><span class=\"fa fa-times fa-fw\"></span></button></div> "/>
    </json:object>
  </json:array>
  <json:array name="data" var="formSubmission" items="${AdminHelper.getDatastoreRecords(currentRobot)}">
    <json:object>
      <c:forEach var="field" items="${fields}">
