...
<c:if test="${not identity.spaceAdmin}">
    <c:set var="error" value="${i18n.translate('You do not have permission to configure the SPACENAME space.')
        .replace('SPACENAME', '<b>SPACENAME</b>').replace('SPACENAME', space.name)}" />
</c:if>
