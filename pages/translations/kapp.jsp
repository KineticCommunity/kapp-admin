                    ...
                    <div class="translation-navigation">
                        <ul class="nav nav-pills sub-nav" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#translations" aria-controls="home" role="tab" data-toggle="tab">${translationKapp.name} Translations</a>
                            </li>
                            <li>
                                <a href="#children" aria-controls="home" role="tab" data-toggle="tab">Forms</a>
                            </li>
                            <li class="pull-right">
                                <select name="" id="">
                    ...
                    <div class="tab-content translations-tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="children">
                            <table class="table table-hover datastore-list-table"> 
                                ...
                                <tbody>
                                    <c:forEach items="${translationKapp.forms}" var="kappForm">
                                        <tr>
                                            <td><a href="${bundle.kappLocation}/${form.slug}?kapp=${param.kapp}&page=translations/form&slug=${kappForm.slug}&kappSlug=${param.slug}">${kappForm.name}</a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
